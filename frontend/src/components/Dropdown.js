...
const Dropdown = ({ id, options, onChange }) => {
	return (
		<>
			...
			<select
				id={id}
				className="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none focus:outline-none focus:ring-0 focus:border-indigo-500 focus:text-gray-900"
